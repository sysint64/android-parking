...
import ru.kabylin.andrey.parking.ContextStringify
import ru.kabylin.andrey.parking.containers.EitherStringRes
 ...
 * пример составления можно найти тут: [ru.kabylin.andrey.parking.client.ErrorsCompositorTest.TestReasons]
 */
